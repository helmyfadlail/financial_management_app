...
export async function GET(req: NextRequest) {
  try {
    ...
    // ── Totals (TRANSFER excluded from income/expense/balance) ────────────
    ...
    // Largest transaction across all types
    ...
    // ── Top expense categories (TRANSFER has no categoryId — skip) ────────
    ...
    // ── Daily spending trend (EXPENSE only) ───────────────────────────────
